...
**Format** 3-day course, with editions in 2023 and 2024.
...
**Format** 1-day course, with editions in 2023 and 2024.
...
R objects, and using control flow.
...
command line arguments and options, and automated execution.
...
programming, and the state of the art in radiological waste characterization.
...
principles, data visualization types, and animation.
...
### [Report of RILEM TC 281-CCC: insights into factors affecting the carbonation rate of concrete with SCMs revealed from data mining and machine learning approaches.](https://doi.org/10.1617/s11527-024-02465-0)
...
**Authors** Vollpracht A, Gluth GJG, Rogiers B, Uwanuakwa ID, Phung QT, Villagran Zaccardi Y, Thiel C, Vanoutrive H, Etcheverry JM, Gruyaert E, Kamali-Bernard S, Kanellopoulos A, Zhao Z, Martins IM, Rathnarajan S, De Belie N.
